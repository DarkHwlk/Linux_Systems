...
void chat_func(int server_fd)
{
	...
	memset(recvbuff, '0', BUFF_SIZE);
        ...
        /* Goi thông điệp tới server bằng hàm write */
        ...
        /* Nhận thông điệp từ server bằng hàm read, ham bi block cho den khi nhan duoc thong diep tu server */
...
int main(int argc, char *argv[])
{
    int portno;
    int server_fd;
    struct sockaddr_in serv_addr;  //Tao dia chi server
