...
int main(int argc, char const *argv[])
{
     ...
     */
    key_t key = ftok("./shmfile", 65);  //Tao key
     ...
     */
    int shmid = shmget(key, 1024, 0666 | IPC_CREAT);  //Tao shared memory voi key, kich thuoc, quyen
     ...
     */   
    char *str = (char*)shmat(shmid, (void *)0, 0);  //attach vung nho process toi shared memory

    // Nhap du lieu va luu vao str duoc mapping den shared memory
